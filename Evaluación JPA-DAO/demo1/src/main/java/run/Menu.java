...
public class Menu {
    // Mantener el EM gestionado de forma más segura; no inicializarlo como field directo
    private final EntityManager em;
    MascotaDao mascotaDao;
    public static Scanner sc = new Scanner(System.in);

    public Menu() {
        // Inicialización segura del EntityManager
        this.em = JPAUtil.getEntityManager();
        this.mascotaDao = new MascotaDao(em);
    }
